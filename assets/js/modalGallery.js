document.addEventListener('DOMContentLoaded', function () {
    ...
    const imageUrls = [
        ...
        './assets/images/food_butter_paneer_with_palak_rice.jpg',
        './assets/images/food_tandoori_chicken_palak_rice.jpg',
    ...
    const imageNames = [
        ...
        'Indian Thali',
        'Indian Thali',
        'Butter Paneer with Palak Rice',
        'Tandoori Chicken with Palak Rice',
        'Sabudana Vada',
        'Kheema Pav',
        'Butter Chicken',
        'Pastry',
